    ...
    if (authNav) {
        if (currentUser) {
            authNav.innerHTML = `
                ...
                <li class="nav-item"><a class="nav-link" href="./wishlist" id="wishlistLink">Wishlist</a></li>
                <li class="nav-item"><a class="nav-link" href="./basket.html" id="basketLink">Basket</a></li>
...
function setupWishlistListeners() {
    ...
    heartIcons.forEach(icon => {
        ...
        icon.addEventListener("click", () => {
            if (!currentUser) {
                showToast("First Login", "linear-gradient(to right,rgb(124, 23, 218),rgb(51, 214, 255))");
        ...
        <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <a href="./product-detail.html?id=${product.id}">More...</a>
                </div>
            </div>
        </div>
    `).join('')
